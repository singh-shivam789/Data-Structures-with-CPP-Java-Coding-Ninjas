...
Given a generic tree, find and return the number of all nodes present in the given tree.
...
Output Format :
The first and only line of output prints the number of all nodes of the given generic tree.
